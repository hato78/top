            ...
            data() {
                return {
                    ...
                    projects: [
                        ...
                        { id: 'hosokawa', name: 'Hosokawa Project', date: '2023.5 - 2024.5', logo: 'logo/hosokawa.png', icons: ['fa-brands fa-html5', 'fa-brands fa-css', 'fa-brands fa-square-js', 'fa-brands fa-php'], file: 'hosokawa.html' },
